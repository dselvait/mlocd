...
public class DMW extends Classifier {
...
//			int index = 0;
			for (String dataset : datasets) {
				...
				Iterator<Map.Entry<Classifier, Double>> i = classifierMap.entrySet().iterator();
				while( i.hasNext() ){
					Map.Entry<Classifier, Double> me = (Map.Entry<Classifier, Double>) i.next();
					Classifier blearner = me.getKey();
					boolean[] eval = utils.Evaluation.testClassifier(
							blearner, dataset);
